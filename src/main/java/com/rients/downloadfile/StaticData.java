...
public class StaticData {
	...
	public static long endDate = System.currentTimeMillis(); //01-01-2018
	...
	public List<Coin> getDownloadData() {
		return Arrays.asList(
				...
				new Coin(4, "Polkadot", "DOT", 6636),
				new Coin(5, "XRP", "XRP", 52),
				new Coin(6, "Cardano", "ADA", 2010),
				new Coin(7, "Chainlink", "LINK", 1975),
				new Coin(8, "Litecoin", "LTC", 2),
				new Coin(9, "Bitcoin Cash", "BCH", 1831),
				new Coin(10, "Binance Coin", "BNB", 1839));
	}

	public static boolean contains(List<Coin> coins, int id) {
		return coins.stream().anyMatch(coin -> coin.getId() == id);
	}
